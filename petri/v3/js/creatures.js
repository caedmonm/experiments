        ...
        for (var i in creatures){
            if (creatures[i] != this && this.checkCompatible(creatures[i])){  
                if(this.location.dist(creatures[i].location) < dist){
                    ...
                    ctx.lineWidth=.1;
                    ctx.stroke();
                    this.special = creatures[i].special;
                    this.color = creatures[i].special.col;
                }
            }
        }
    },
