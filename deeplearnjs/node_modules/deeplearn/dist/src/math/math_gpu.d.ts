...
export declare class NDArrayMathGPU extends NDArrayMath {
    ...
    protected multinomialInternal(probs: Array1D, numSamples: number, seed: number): Array1D;
    protected oneHotInternal(indices: ndarray.Array1D, depth: number, onValue: number, offValue: number): ndarray.Array2D;
