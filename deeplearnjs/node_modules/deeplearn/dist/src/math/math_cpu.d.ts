...
export declare class NDArrayMathCPU extends NDArrayMath {
    ...
    protected multinomialInternal(probabilities: Array1D, numSamples: number, seed: number): Array1D;
    protected oneHotInternal(indices: Array1D, depth: number, onValue: number, offValue: number): Array2D;
}
